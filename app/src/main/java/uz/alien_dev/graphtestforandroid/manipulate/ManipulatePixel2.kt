...
class ManipulatePixel2 : View {
    ...
    class GraphLoop(private val graph: ManipulatePixel2) : Thread() {
    ...
    private fun createTask() {
        for (x in 0 until width) for (y in 0 until height) pixel(x, y, x * 255 / width, y * 255 / height, 255)
    }
