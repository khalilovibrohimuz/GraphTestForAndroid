...
class ManipulatePixel1 : View {
    ...
    class GraphLoop(private val graph: ManipulatePixel1) : Thread() {
    ...
    private external fun pixel(bitmap: Bitmap, x: Int, y: Int, r: Int, g: Int, b: Int)

    private fun createTask() {
        for (x in 0 until width) for (y in 0 until height) pixel(bitmap, x, y, x * 255 / width, y * 255 / height, 255)
    }
